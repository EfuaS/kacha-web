...
export default function BillPayment3() {
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col  modalDimensions outline-none focus:outline-none">
                  ...
                  <div className="relative p-6 flex flex-col items-center text-center ">
                    <div className="py-6 px-16 inputCol w-80">
                      ...
                      <span className="block heading text-lg leading-6 text-black mt-2.5">
                        Br {userData.amount}{" "}
                  ...
                  <div className="flex flex-col items-center  heading text-sm text-slate-700 text-center">
                    <div className="flex flex-row  pt-4 pb-1 inputCol w-80 ">
                      <p className="pl-6">Account number</p>
                      <p className="ml-20">{biller}</p>
                    </div>
                    <div className="flex flex-row  pb-1 inputCol w-80">
                      <p className="pl-6">Account name</p>
                      <p className="ml-24">{userData.to_name}</p>
                    </div>
                    <div className="flex flex-row justify-spaced pb-4 inputCol w-80">
                      <p className="pl-6">Bill type</p>
                      <p className="ml-36">{userData.reference}</p>
                    </div>
                  </div>
